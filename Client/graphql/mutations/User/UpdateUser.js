...
export const UPDATE_USER_MUTATION = gql`
    mutation updateUser($facebookUserId: facebookUserId!, $bio: String!, $course: String!, $studyYear: String!, $isSmoker: Boolean!, $socialScore: Int!, $minPrice: Int!, $maxPrice: Int!, $genderPreference: String!) {
