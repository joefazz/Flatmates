    ...
    render() {
        return (
            <ScrollView contentContainerStyle={{ alignItems: 'center', justifyContent: 'center', paddingHorizontal: 5 }}>
                ...
                <Text style={{ ...FontFactory() }}>Hi. Thanks for downloading Flatmates!{"\n"}
                    ...
                    {"\n"}{"\n"}Flatmates is designed to be a replacement for the Facebook groups that are often run by student unions.
I was disappointed by the lack of structure the current solutions offered, posts would range between having lots of detail and not even
listing the cost of rent. I started coding it in November 2017, about
5 minutes after watching "The Social Network". It is the product of many hundreds of hours
                ...
                <Text style={{ ...FontFactory({ weight: 'Bold' }), fontSize: 16, alignSelf: 'flex-start' }}>About me.</Text>
                <Text style={{ ...FontFactory() }}>
                    I'm currently a 3rd year Computer Science student at the University of Reading.
                    While doing a placement year at Fluid.Work, developing and maintaining their iOS and Android applications,
                    I came up with the idea for Flatmates. I actively maintain and work on Flatmates while working part time.
                    I'm also currently in the planning phase of my final year project, which is a website that lets users sign up and start
                ...
                <Text style={{ ...FontFactory() }}>
                    ...
                    Flatmates was originally quite different. Originally the plan was to use the Facebook Login API to get information about
